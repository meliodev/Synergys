...
export default class Dashboard extends Component {
    ...
    render() {
        ...
        const colors1 = { primary: '#4699f5', secondary: '#bfe1fa', tertiary: '#cee8f9' }
        const colors2 = { primary: '#fab627', secondary: '#fbde98', tertiary: '#faebce' }
        const colors3 = { primary: '#fa2788', secondary: '#f8bad1', tertiary: '#f8d6e4' }

        return (
            <NewBackground style={styles.mainContainer}>
                <Appbar menu title titleText='Accueil' />
                <View style={styles.contentContainer}>
                    {this.renderItem(faLayerPlus, colors1, 'NOUVEAUTÉS', 'Summary', { backgroundColor: '#deeff9' })}
                    {this.renderItem(faChartLine, colors2, 'STATISTIQUES', 'Statistics', { backgroundColor: '#fbf4e4' })}
                    {this.renderItem(faArrowAltToRight, colors3, 'RACCOURCIS', 'Shortcuts', { backgroundColor: '#f9e6ec' })}
                </View>
            </NewBackground>
        )
    }
