...
class ListProjects extends Component {
  ...
  renderProject(project) {
    return (
      <ProjectItem
        project={project}
        onPress={() => this.onPressProject(project)}
      />
    );
  }
  ...
  render() {
    ...
    this.filteredProjects = handleFilter(
      projectsList,
      this.filteredProjects,
      fields,
      searchInput,
          ...
          <View style={styles.container}>
            ...
            {projectsCount > 0 ? (
              ...
              <EmptyList
                ...
                description='Gérez tous vos projets. Appuyez sur le boutton "+" pour en créer un nouveau.'
              />
            )}
