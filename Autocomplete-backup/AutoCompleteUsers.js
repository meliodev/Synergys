...
export default class AutoCompleteUsers extends React.Component {
    ...
    customRenderSuggestion = suggestion => {
        ...
        return (
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 15, borderBottomWidth: StyleSheet.hairlineWidth * 9, borderBottomColor: theme.colors.gray2 }}>
                <Text>{name}</Text>
