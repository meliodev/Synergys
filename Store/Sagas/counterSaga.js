...
import { delay, takeEvery, takeLatest, put } from 'redux-saga/effects'// Worker: Increase Counter Async (Delayed By 4 Seconds)

function* increaseCounterAsync() {
    try {
        // Delay 4 Seconds
        yield delay(4000)   // Dispatch Action To Redux Store
        yield put({
