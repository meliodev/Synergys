...
import { generateId, updateField, load, navigateToScreen, setAddress, displayError, setToast } from "../../core/utils"
...
class CreateClient extends Component {
    ...
    handleSubmit = async () => {
        ...
        if (error) {
            ...
            var navParams = this.prevScreen === "CreateProject" ? {} : { user: { id: this.ClientId, roleId: 'client' }, isClient: true, isEdit: false }
            this.setState({ loadingDialog: false }, () => {
    ...
    render() {
        ...
        let { nom, prenom, address, addressError, phone, email, email2, password } = this.state
