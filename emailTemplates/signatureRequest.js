...
<p style="line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 18px; margin: 0;">Vous venez d'initier une procédure de signature d'un document via l'application BTV.</p>
<p style="line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 18px; margin: 0;">Afin de compléter la signature, veuillez renseigner, dans l'interface de l'application BTV, le code à 6 chiffres que vous venez de recevoir par SMS.</p>
